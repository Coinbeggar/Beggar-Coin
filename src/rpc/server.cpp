...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BGGR features */
        {"beggar", "listmasternodes", &listmasternodes, true },
        {"beggar", "getmasternodecount", &getmasternodecount, true },
        {"beggar", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"beggar", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"beggar", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"beggar", "masternodecurrent", &masternodecurrent, true },
        {"beggar", "startmasternode", &startmasternode, true },
        {"beggar", "createmasternodekey", &createmasternodekey, true },
        {"beggar", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"beggar", "listmasternodeconf", &listmasternodeconf, true },
        {"beggar", "getmasternodestatus", &getmasternodestatus, true },
        {"beggar", "getmasternodewinners", &getmasternodewinners, true },
        {"beggar", "getmasternodescores", &getmasternodescores, true },
        {"beggar", "preparebudget", &preparebudget, true },
        {"beggar", "submitbudget", &submitbudget, true },
        {"beggar", "mnbudgetvote", &mnbudgetvote, true },
        {"beggar", "getbudgetvotes", &getbudgetvotes, true },
        {"beggar", "getnextsuperblock", &getnextsuperblock, true },
        {"beggar", "getbudgetprojection", &getbudgetprojection, true },
        {"beggar", "getbudgetinfo", &getbudgetinfo, true },
        {"beggar", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"beggar", "mnfinalbudget", &mnfinalbudget, true },
        {"beggar", "checkbudgets", &checkbudgets, true },
        {"beggar", "mnsync", &mnsync, true },
        {"beggar", "spork", &spork, true },
...
{
    return "> beggar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:5477/\n";
}
