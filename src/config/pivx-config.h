...
#define PACKAGE_BUGREPORT "https://github.com/beggarcrypto/beggar/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "beggar Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "beggar Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "beggar"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://beggar.foundation/"
