...
{
    const char* pszTimestamp = "hello world, hello";
...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256S("0x0000055cbf23ffe1ed0118aa64e012f6b525f5bcb6090abb31be49f09c593097"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1666513258, // * UNIX timestamp of last checkpoint block
...
/**
        ...
        // /////////////////////////////////////////////////////////////////
         ...
         uint32_t nGenesisTime = 1666622011;
         arith_uint256 test;
         bool fNegative;
         bool fOverflow;
...
*/
        ...
        genesis = CreateGenesisBlock(1666622011, 1853374, 0x1e0ffff0, 1, 0 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x0000055cbf23ffe1ed0118aa64e012f6b525f5bcb6090abb31be49f09c593097"));
        assert(genesis.hashMerkleRoot == uint256S("0xd73b42ff28c22a9783ecf29a6496fc36927d4957cbdcd557b7f4ea847da51348"));
        ...
        // spork keys
        consensus.strSporkPubKey = "032ffddbe550859354f116067b7708b57e279d8048a1c24945276b0acbcb216e6a";
        ...
        vSeeds.push_back(CDNSSeedData("seed01", "seed01.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed02", "seed02.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed03", "seed03.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed04", "seed04.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed05", "seed05.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed06", "seed06.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed07", "seed07.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed08", "seed08.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed09", "seed09.beggar.foundation"));
        vSeeds.push_back(CDNSSeedData("seed10", "seed10.beggar.foundation"));
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit   = ~UINT256_ZERO >> 20;   // beggar starting difficulty is 1 / 2^12
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // Testnet beggar addresses start with 'T'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 66);  // Testnet beggar script addresses start with 'T'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet beggar BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet beggar BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet beggar BIP44 coin type is '1' (All coin's testnet default)
