...
CAmount CMasternode::GetMasternodeNodeCollateral(int nHeight) 
{
    ...
    if (nHeight >  1900000) return     150000 * COIN;
    if (nHeight >  1800000) return     140000 * COIN;
    if (nHeight >  1700000) return     130000 * COIN;
    if (nHeight >  1600000) return     120000 * COIN;
    if (nHeight >  1500000) return     110000 * COIN;
    if (nHeight >  1400000) return     100000 * COIN;
    if (nHeight >  1300000) return     900000 * COIN;
    if (nHeight >  1200000) return     80000 * COIN;
    if (nHeight >  1100000) return     70000 * COIN;
    if (nHeight >  1000000) return     60000 * COIN;
    if (nHeight >  900000) return      55000 * COIN;
    if (nHeight >  800000) return      50000 * COIN;
    if (nHeight >  700000) return      45000 * COIN;
    if (nHeight >  600000) return      40000 * COIN;
    if (nHeight >  500000) return      35000 * COIN;
    ...
    if (nHeight >  30000) return       7000 * COIN;
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 BGGR tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                                        // block for 1000 BGGR tx -> 1 confirmation
