...
#define __PORT_MAINNET__ 5476
#define __PORT_TESTNET__ 15476
#define __PORT_REGTEST__ 25476
 ...
 * beggar system. There are three: the main network on which people trade goods
