...
/* beggar GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "beggar"
#define QAPP_ORG_DOMAIN "beggar.org"
#define QAPP_APP_NAME_DEFAULT "beggar-Qt"
#define QAPP_APP_NAME_TESTNET "beggar-Qt-testnet"
