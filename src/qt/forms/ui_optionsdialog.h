...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start BGGR after logging in to the system.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start BGGR on system login", Q_NULLPTR));
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintEnable->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic minting of BGGR units to zBGGR", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintEnable->setText(QApplication::translate("OptionsDialog", "Enable zBGGR Automint", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        checkBoxZeromintAddresses->setToolTip(QApplication::translate("OptionsDialog", "Enable automatic zBGGR minting from specific addresses", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        checkBoxZeromintAddresses->setText(QApplication::translate("OptionsDialog", "Enable Automint Addresses", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        percentage_label->setToolTip(QApplication::translate("OptionsDialog", "Percentage of incoming BGGR which get automatically converted to zBGGR via Zerocoin Protocol (min: 10%)", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        percentage_label->setText(QApplication::translate("OptionsDialog", "Percentage of autominted zBGGR", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        labelPreferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough BGGR for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        labelPreferredDenom->setText(QApplication::translate("OptionsDialog", "Preferred Automint zBGGR Denomination", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        preferredDenom->setToolTip(QApplication::translate("OptionsDialog", "Wait with automatic conversion to Zerocoin until enough BGGR for this denomination is available", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the BGGR client port on the router. This only works when your router supports UPnP and it is enabled.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the BGGR network through a SOCKS5 proxy.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting BGGR.", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
...
"https://discord.gg/ARRRgQzpdZ", Q_NULLPTR));
