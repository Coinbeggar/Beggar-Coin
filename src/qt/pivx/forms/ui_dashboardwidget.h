...
public:
    ...
    void setupUi(QWidget *DashboardWidget)
    {
        ...
        labelAmountPiv->setText(QStringLiteral("0 BGGR"));
        ...
        labelPiv->setText(QStringLiteral("STAKING"));
...
"}"));
    ...
    void retranslateUi(QWidget *DashboardWidget)
    {
        ...
        labelMessage->setText(QApplication::translate("DashboardWidget", "Amount of BGGR staked.", Q_NULLPTR));
        ...
        labelMNRewards->setText(QApplication::translate("DashboardWidget", "MASTERNODES", Q_NULLPTR));
