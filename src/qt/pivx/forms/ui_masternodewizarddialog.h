...
public:
    ...
    void retranslateUi(QDialog *MasterNodeWizardDialog)
    {
        ...
        labelMessage1a->setText(QApplication::translate("MasterNodeWizardDialog", "<html><head/><body><p>To create a BGGR masternode you must dedicate a BGGR amount to the network (however, these coins are still yours and will never leave your possession). </p><p></p><p>You can deactivate the node and unlock the coins at any time.</p></body></html>", Q_NULLPTR));
