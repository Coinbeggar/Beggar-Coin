...
public:
    ...
    void retranslateUi(QDialog *WelcomeContentWidget)
    {
        ...
        pushName2->setText(QApplication::translate("WelcomeContentWidget", "beggar", Q_NULLPTR));
        pushName3->setText(QApplication::translate("WelcomeContentWidget", "Foundation", Q_NULLPTR));
...
"Beggar Wallet", Q_NULLPTR));
        labelMessage2->setText(QApplication::translate("WelcomeContentWidget", "Every child deserve a better life, help them to have one.", Q_NULLPTR));
        labelTitle3->setText(QApplication::translate("WelcomeContentWidget", "Our children, our future", Q_NULLPTR));
        labelMessage3->setText(QApplication::translate("WelcomeContentWidget", "<html><head/><body><p>Together we can offer a better place in the world to all those children. Our contribution aims to offer food and education to those most in need..</p></body></html>", Q_NULLPTR));
        labelTitle4->setText(QApplication::translate("WelcomeContentWidget", "What is a Masternode?", Q_NULLPTR));
        labelMessage4->setText(QApplication::translate("WelcomeContentWidget", "Masternodes are part of the infrastructure that sustains beggar coin. They verify new blocks and perform special roles in governing the blockchain.", Q_NULLPTR));
    } // retranslateUi
