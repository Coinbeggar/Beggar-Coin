...
"             }"));
    ...
    void retranslateUi(QWidget *send)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("send", "Send public coins (BGGR)", Q_NULLPTR));
        labelSubtitleAddress->setText(QApplication::translate("send", "BGGR address or contact label", Q_NULLPTR));
