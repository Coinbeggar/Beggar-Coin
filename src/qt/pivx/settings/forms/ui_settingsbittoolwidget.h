...
public:
    ...
    void retranslateUi(QWidget *SettingsBitToolWidget)
    {
        ...
        labelSubtitle1->setText(QApplication::translate("SettingsBitToolWidget", "Encrypt your BGGR addresses (key pair actually) using BIP38 encryption.\n"
"Using this mechanism you can share your keys without middle-man risk, only need to store your passphrase safely", Q_NULLPTR));
        ...
        labelSubtitleAddress->setText(QApplication::translate("SettingsBitToolWidget", "BGGR address", Q_NULLPTR));
