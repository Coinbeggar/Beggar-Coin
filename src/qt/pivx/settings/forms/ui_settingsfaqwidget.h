...
public:
    ...
    void retranslateUi(QWidget *SettingsFaqWidget)
    {
        ...
        pushButton_Intro->setText(QApplication::translate("SettingsFaqWidget", "1) What is BGGR?", Q_NULLPTR));
        pushButton_UnspendablePIV->setText(QApplication::translate("SettingsFaqWidget", "2) Why are my BGGR unspendable?", Q_NULLPTR));
        pushButton_Stake->setText(QApplication::translate("SettingsFaqWidget", "3) How do I stake BGGR?", Q_NULLPTR));
        ...
        pushButtonWebLink->setText(QApplication::translate("SettingsFaqWidget", "https://beggar.foundation/", Q_NULLPTR));
        labelNumber_Intro->setText(QApplication::translate("SettingsFaqWidget", "1", Q_NULLPTR));
        labelSubtitle_Intro->setText(QApplication::translate("SettingsFaqWidget", "What is BGGR?", Q_NULLPTR));
...
"         "
        ...
        labelSubtitle_UnspendablePIV->setText(QApplication::translate("SettingsFaqWidget", "Why are my BGGR unspendable?", Q_NULLPTR));
...
"                         ", Q_NULLPTR));
        ...
        labelSubtitle_Stake->setText(QApplication::translate("SettingsFaqWidget", "How do I stake BGGR?", Q_NULLPTR));
        labelContent_Stake->setText(QApplication::translate("SettingsFaqWidget", "<html><head/><body><ol style=\"margin-top: 0px; margin-bottom: 0px; margin-left: 0px; margin-right: 0px; -qt-list-indent: 1;\"><li align=\"justify\" style=\" margin-top:12px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Make sure your wallet is completely synchronized and you are using the latest release. </li><li align=\"justify\" style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">You must have a balance of BGGR with a minimum of 600 confirmations. </li><li align=\"justify\" style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Your wallet must stay online and be unlocked for staking purposes. </li><li align=\"justify\" style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Once all those steps are followed staking should be enabled. </li><li align=\"justify\" style=\" ma"
                        "rgin-top:0px; margin-bottom:12px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">You can see the status of staking in the wallet by mousing over the package icon in the row on the top left of the wallet interface. There package will be lit up and will state &quot;Staking Enabled&quot; to indicate it is staking. Using the command line interface (beggar-cli); the command <span style=\" font-style:italic;\">getstakingstatus</span> will confirm that staking is active. </li></ol></body></html>", Q_NULLPTR));
