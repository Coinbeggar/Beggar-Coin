...
/** Utility functions used by the beggar Qt UI.
 */
namespace GUIUtil
{
...
// Render BGGR addresses in monospace font
...
// Parse "beggar:" URI into recipient object, return true on successful parsing
