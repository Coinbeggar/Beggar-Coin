...
#man pages
Source20:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/beggard.1
Source21:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/beggar-cli.1
Source22:	https://raw.githubusercontent.com/pivx-project/pivx/v%{version}/doc/man/beggar-qt.1
...
%if %{_buildqt}
# qt icons
install -D -p share/pixmaps/beggar.ico %{buildroot}%{_datadir}/pixmaps/beggar.ico
install -p share/pixmaps/nsis-header.bmp %{buildroot}%{_datadir}/pixmaps/
install -p share/pixmaps/nsis-wizard.bmp %{buildroot}%{_datadir}/pixmaps/
install -p %{SOURCE100} %{buildroot}%{_datadir}/pixmaps/pivx.svg
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/beggar16.png -w16 -h16
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/beggar32.png -w32 -h32
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/beggar64.png -w64 -h64
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/beggar128.png -w128 -h128
%{_bindir}/inkscape %{SOURCE100} --export-png=%{buildroot}%{_datadir}/pixmaps/beggar256.png -w256 -h256
%{_bindir}/convert -resize 16x16 %{buildroot}%{_datadir}/pixmaps/beggar256.png %{buildroot}%{_datadir}/pixmaps/beggar16.xpm
%{_bindir}/convert -resize 32x32 %{buildroot}%{_datadir}/pixmaps/beggar256.png %{buildroot}%{_datadir}/pixmaps/beggar32.xpm
%{_bindir}/convert -resize 64x64 %{buildroot}%{_datadir}/pixmaps/beggar256.png %{buildroot}%{_datadir}/pixmaps/beggar64.xpm
%{_bindir}/convert -resize 128x128 %{buildroot}%{_datadir}/pixmaps/beggar256.png %{buildroot}%{_datadir}/pixmaps/beggar128.xpm
%{_bindir}/convert %{buildroot}%{_datadir}/pixmaps/beggar256.png %{buildroot}%{_datadir}/pixmaps/beggar256.xpm
