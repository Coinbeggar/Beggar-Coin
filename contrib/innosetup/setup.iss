...
#define MyAppName "beggar"
#define MyAppPublisher "2022 beggar developers"
#define MyAppURL "https://beggar.foundation/"
#define MyAppExeName "beggar-qt.exe"
//#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/BGGR/bootstrap.zip"
...
OutputDir=.\output
OutputBaseFilename=beggarSetup
...
[Files]
Source: ".\package\beggar-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\beggar\beggar-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\beggar\beggar-Qt,strDataDir|{userappdata}\beggar\}');
  Result := True;
end;
