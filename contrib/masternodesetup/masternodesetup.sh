...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='beggar.conf'
CONFIGFOLDER='/root/.beggar'
COIN_DAEMON='beggard'
COIN_CLI='beggar-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/beggarBF/beggar/releases/latest | grep "browser_download_url.*Linux\\.tar.gz" | cut -d : -f 2,3 | tr -d \" | xargs`
