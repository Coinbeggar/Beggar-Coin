...
"""Verify that starting beggar with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beggar with -? for help text")
        ...
        self.log.info("Start beggar with -version for version information")
