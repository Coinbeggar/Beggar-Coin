Contributing to beggar Core
============================

The beggar Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/beggarBF/beggar/blob/master/doc/translation_process.md)
...
The following applies to code changes to the beggar Core project, and is not to be
confused with overall beggar Network Protocol consensus changes.

Whether a pull request is merged into beggar Core rests with the project merge
...
Patches that change beggar consensus rules are considerably more involved than
...
Where a patchset proposes to change the beggar consensus, it must have been
...
The project leader is the release manager for each beggar Core release.
